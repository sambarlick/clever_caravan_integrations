...
This Home Assistant custom component uses the [Bureau of Meteorology (BOM)](http://www.bom.gov.au) as a source for weather information, adapted for travellers and caravan enthusiasts who move around Australia.
...
This integration is a fork of the excellent [bureau_of_meteorology](https://github.com/bremor/bureau_of_meteorology) custom component originally created by [@bremor](https://github.com/bremor) and contributors. The core data fetching, sensor definitions, forecast formatting, and HA integration architecture are all their work. This fork adapts that foundation to use dynamic Home Zone location tracking.
...
1. Copy the `custom_components/clever_caravan_weather` directory into your Home Assistant `custom_components` folder.
2. Restart Home Assistant.

### HACS (Custom Repository)

1. In HACS, go to **Integrations** → **Custom Repositories**.
2. Add `https://github.com/sambarlick/bureau_of_meteorology` as a custom repository (category: Integration).
...
2. Click **+ Add Integration** and search for **Clever Caravan Weather**.
3. Click through the setup — no location entry required. The integration reads your Home Zone automatically.
...
### 2.0.0 - Dynamic Home Zone location tracking

- Forked from [bureau_of_meteorology](https://github.com/bremor/bureau_of_meteorology) by [@bremor](https://github.com/bremor).
- Removed static lat/lon configuration — integration now reads location from `zone.home` automatically.
- Location is re-evaluated on every refresh cycle; weather data updates whenever the Home Zone changes.
- Setup flow simplified — no location entry required during onboarding.
...
*Built for [Clever Caravan](https://github.com/sambarlick) · Based on the work of [@bremor](https://github.com/bremor) and contributors · Data provided by the [Australian Bureau of Meteorology](http://www.bom.gov.au)*
